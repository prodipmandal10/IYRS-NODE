...
GREEN="\e[32m"
YELLOW="\e[33m"
GOLD="\e[38;5;178m" # নতুন গভীর সোনালি রঙ
RED="\e[31m"
BOLD='\033[1m'
...
    echo -e "${GOLD}${BOLD} # # # # # 🌟 IYRS NODERUN 🌟 # # # # #${RESET}"
    echo -e "${GOLD}${BOLD} # # # # # # MADE BY PRODIP # # # # # #${RESET}"
    echo -e "${GOLD}${BOLD}=====================================================${RESET}"
...
# --- র্যান্ডম JPG ফাইল তৈরি করা (~8 KB) ---
generate_random_jpg() {
...
    print_header
    echo -e "${GOLD}${BOLD}╔══════════════════════════════════════════════╗${RESET}"
    echo -e "${GOLD}${BOLD}║      ${YELLOW}${BOLD}🔵 BENGAL AIRDROP IYRS MENU 🔵${GOLD}${BOLD}     ║${RESET}"
    echo -e "${GOLD}${BOLD}╠══════════════════════════════════════════════╣${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}1${RESET}${BOLD}] ${PINK}📦 Install Dependencies & Irys CLI         ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}2${RESET}${BOLD}] ${PINK}⚙️ Setup Config (Private Key / RPC / Wallet)${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}3${RESET}${BOLD}] ${PINK}🔄 Change Config (RPC / Key / Wallet)      ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}4${RESET}${BOLD}] ${PINK}💰 Fund Wallet (Devnet)                   ${GOLD}${BOLD} ║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}5${RESET}${BOLD}] ${PINK}🔍 Check Wallet Balance                    ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}6${RESET}${BOLD}] ${PINK}⬆️ Upload File (Manual)                    ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}7${RESET}${BOLD}] ${PINK}🔄 Auto-generate & Upload Random JPG     ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}8${RESET}${BOLD}] ${PINK}📜 View Uploaded Files                    ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}║ [${YELLOW}0${RESET}${BOLD}] ${PINK}👋 Exit Script                            ${GOLD}${BOLD}║${RESET}"
    echo -e "${GOLD}${BOLD}╚══════════════════════════════════════════════╝${RESET}"
    echo ""
    
